        ...
        <div className="mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-[1fr_410px] xl:gap-20">
          ...
          <div className="hidden lg:block">
            ...
            <p className="mt-7 max-w-xl text-[15px] leading-7 text-slate-400">
              Atlas brings your information, research, and
              knowledge workflows together in one secure
              intelligence platform.
            </p>

            {/* Atlas intelligence visual */}
              ...
              <div className="relative">
                ...
                <div className="mb-6">
                  ...
                  <p className="mt-1.5 text-sm leading-6 text-slate-400">
                    Join Atlas and start building your
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        autoComplete="new-password"
                        required
                        className={`w-full rounded-xl border bg-black/20 px-4 py-3 pr-12 text-sm text-white outline-none transition placeholder:text-slate-600 focus:bg-black/25 focus:ring-4 ${
                          confirmPassword &&
                          password !== confirmPassword
                            ? "border-red-400/40 focus:border-red-400/60 focus:ring-red-500/[0.08]"
                            : "border-white/10 focus:border-blue-400/50 focus:ring-blue-500/[0.08]"
                        }`}
                      />
                  ...
                  <div className="flex items-start gap-2 pt-1">
                    ...
                    <p className="text-[11px] leading-5 text-slate-500">
                      Your email will be verified with a
